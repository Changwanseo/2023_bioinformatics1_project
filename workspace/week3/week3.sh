...
samtools view -b -o CLIP-let7f-1.bam ../../data/project/CLIP-35L33G.bam chr9:106056039-106056126
...
awk '$2 >= 106056039 && $2 <= 106056126 { print $0; }' CLIP-let7f-1.pileup > CLIP-let7f-1-gene.pileup
tail CLIP-let7f-1-gene.pileup



#chr13:48689488-8689590
grep -i mirlet7d ../../data/gencode.vM27.annotation.gtf
samtools view -b -o CLIP-let7d.bam ../../data/project/CLIP-35L33G.bam chr9:106056039-106056126
...
awk '$2 >= 106056039 && $2 <= 106056126 { print $0; }' CLIP-let7d.pileup > CLIP-let7d-gene.pileup
